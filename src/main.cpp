...
int nCoinbaseMaturity = 15;  //20 blocks
...
const string strMessageMagic = "Cblcoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees, int nHeight)
{
    ...
    } else if(pindexBest->nHeight >= 1 && pindexBest->nHeight <= 10000){
      nSubsidy = 1 * COIN;
    } else if(pindexBest->nHeight >= 10001 && pindexBest->nHeight < 11000){
      nSubsidy = 1 * COIN;
    } else{
      nSubsidy = 1 * COIN;	  
    }
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees, int nHeight)
{
    ...
    if(nBestHeight >= 1 && nBestHeight <= 14999){
      nSubsidy = 1 * COIN;
    } else if(nBestHeight >= 15000 && nBestHeight < 21999){
      nSubsidy = 1.25 * COIN;
    } else if(nBestHeight >= 22000 && nBestHeight < 28999){
      nSubsidy = 1.5 * COIN;
    } else if(nBestHeight >= 29000 && nBestHeight < 35999){
      nSubsidy = 1.75 * COIN;
    } else if(nBestHeight >= 36000 && nBestHeight < 42999){
      nSubsidy = 2 * COIN;
    } else if(nBestHeight >= 43000 && nBestHeight < 49999){
      nSubsidy = 2.25 * COIN;
    } else if(nBestHeight >= 50000 && nBestHeight < 56999){
      nSubsidy = 2.50 * COIN;
    } else if(nBestHeight >= 57000 && nBestHeight < 63999){
      nSubsidy = 2.75 * COIN;
    } else if(nBestHeight >= 64000 && nBestHeight < 70999){
      nSubsidy = 3 * COIN;
    } else if(nBestHeight >= 71000 && nBestHeight < 77999){
      nSubsidy = 3.25 * COIN;
    } else if(nBestHeight >= 78000 && nBestHeight < 84999){
      nSubsidy = 3.50 * COIN;
    } else if(nBestHeight >= 85000 && nBestHeight < 91999){
      nSubsidy = 3.75 * COIN;
    } else if(nBestHeight >= 92000 && nBestHeight < 98999){
      nSubsidy = 4 * COIN;
    } else if(nBestHeight >= 99000 && nBestHeight < 105999){
      nSubsidy = 4.25 * COIN;
    } else if(nBestHeight >= 106000 && nBestHeight < 112999){
      nSubsidy = 4.50 * COIN;
    } else if(nBestHeight >= 113000 && nBestHeight < 119999){
      nSubsidy = 4.75 * COIN;
    } else if(nBestHeight >= 120000 && nBestHeight < 126999){
      nSubsidy = 5 * COIN;
    } else if(nBestHeight >= 127000 && nBestHeight < 133999){
      nSubsidy = 5.25 * COIN;
	} else if(nBestHeight >= 134000 && nBestHeight < 140999){
      nSubsidy = 5.50 * COIN;
	} else if(nBestHeight >= 141000 && nBestHeight < 147999){
      nSubsidy = 5.75 * COIN;
	} else if(nBestHeight >= 148000 && nBestHeight < 154999){
      nSubsidy = 6 * COIN;
	} else if(nBestHeight >= 155000 && nBestHeight < 161999){
      nSubsidy = 6.25 * COIN;
	} else if(nBestHeight >= 162000 && nBestHeight < 168999){
      nSubsidy = 6.50 * COIN;
	} else if(nBestHeight >= 169000 && nBestHeight < 175999){
      nSubsidy = 6.75 * COIN;
	} else if(nBestHeight >= 176000 && nBestHeight < 182999){
      nSubsidy = 7 * COIN;	
	} else if(nBestHeight >= 183000 && nBestHeight < 189999){
      nSubsidy = 7.25 * COIN;
	} else if(nBestHeight >= 190000 && nBestHeight < 196999){
      nSubsidy = 7.50 * COIN;
	} else if(nBestHeight >= 197000 && nBestHeight < 203999){
      nSubsidy = 7.75 * COIN;
	} else if(nBestHeight >= 204000 && nBestHeight < 210999){
      nSubsidy = 8 * COIN;
	} else if(nBestHeight >= 211000 && nBestHeight < 217999){
      nSubsidy = 8.25 * COIN;
	} else if(nBestHeight >= 218000 && nBestHeight < 224999){
      nSubsidy = 8.50 * COIN;
	} else if(nBestHeight >= 225000 && nBestHeight < 231999){
      nSubsidy = 8.75 * COIN;
	} else if(nBestHeight >= 232000 && nBestHeight < 238999){
      nSubsidy = 9 * COIN;
	} else if(nBestHeight >= 239000 && nBestHeight < 252999){
      nSubsidy = 9.25 * COIN;
	} else if(nBestHeight >= 253000 && nBestHeight < 259999){
      nSubsidy = 9.50 * COIN;
	} else if(nBestHeight >= 260000 && nBestHeight < 266999){
      nSubsidy = 9.75 * COIN;
	} else if(nBestHeight >= 267000 && nBestHeight < 273999){
      nSubsidy = 10 * COIN;
	} else if(nBestHeight >= 274000 && nBestHeight < 280999){
      nSubsidy = 10.25 * COIN;
	} else if(nBestHeight >= 281000 && nBestHeight < 287999){
      nSubsidy = 10.50 * COIN;
	} else if(nBestHeight >= 288000 && nBestHeight < 294999){
      nSubsidy = 10.75 * COIN;
	} else if(nBestHeight >= 295000 && nBestHeight < 301999){
      nSubsidy = 11 * COIN;
	} else if(nBestHeight >= 302000 && nBestHeight < 308999){
      nSubsidy = 11.25 * COIN;
	} else if(nBestHeight >= 309000 && nBestHeight < 315999){
      nSubsidy = 11.50 * COIN;
	} else if(nBestHeight >= 316000 && nBestHeight < 322999){
      nSubsidy = 11.75 * COIN;
	} else if(nBestHeight >= 323000 && nBestHeight < 329999){
      nSubsidy = 12 * COIN;
	} else if(nBestHeight >= 330000 && nBestHeight < 336999){
      nSubsidy = 11.75 * COIN;
	} else if(nBestHeight >= 337000 && nBestHeight < 343999){
      nSubsidy = 11.50 * COIN;
	} else if(nBestHeight >= 344000 && nBestHeight < 350999){
      nSubsidy = 11.25 * COIN;
	} else if(nBestHeight >= 351000 && nBestHeight < 357999){
      nSubsidy = 11 * COIN;
	} else if(nBestHeight >= 358000 && nBestHeight < 364999){
      nSubsidy = 10.75 * COIN;
	} else if(nBestHeight >= 365000 && nBestHeight < 371999){
      nSubsidy = 10.50 * COIN;
	} else if(nBestHeight >= 372000 && nBestHeight < 378999){
      nSubsidy = 10.25 * COIN;
	} else if(nBestHeight >= 379000 && nBestHeight < 392999){
      nSubsidy = 10 * COIN;	  
	} else if(nBestHeight >= 393000 && nBestHeight < 399999){
      nSubsidy = 9.75 * COIN;	  
	} else if(nBestHeight >= 400000 && nBestHeight < 406999){
      nSubsidy = 9.50 * COIN;	  
	} else if(nBestHeight >= 407000 && nBestHeight < 413999){
      nSubsidy = 9.25 * COIN;	  
	} else if(nBestHeight >= 414000 && nBestHeight < 420999){
      nSubsidy = 9 * COIN;	  
	} else if(nBestHeight >= 421000 && nBestHeight < 427999){
      nSubsidy = 8.75 * COIN;	  
	} else if(nBestHeight >= 428000 && nBestHeight < 434999){
      nSubsidy = 8.50 * COIN;	  
	} else if(nBestHeight >= 435000 && nBestHeight < 441999){
      nSubsidy = 8.25 * COIN;	  
	} else if(nBestHeight >= 442000 && nBestHeight < 448999){
      nSubsidy = 8 * COIN;	  
	} else if(nBestHeight >= 449000 && nBestHeight < 455999){
      nSubsidy = 7.75 * COIN;	  
	} else if(nBestHeight >= 456000 && nBestHeight < 462999){
      nSubsidy = 7.50 * COIN;	  
	} else if(nBestHeight >= 463000 && nBestHeight < 469999){
      nSubsidy = 7.25 * COIN;	  
	} else if(nBestHeight >= 470000 && nBestHeight < 476999){
      nSubsidy = 7 * COIN;	  
	} else if(nBestHeight >= 477000 && nBestHeight < 483999){
      nSubsidy = 6.75 * COIN;	  
	} else if(nBestHeight >= 484000 && nBestHeight < 490999){
      nSubsidy = 6.50 * COIN;	  	 
	} else if(nBestHeight >= 491000 && nBestHeight < 497999){
      nSubsidy = 6.25 * COIN;	  
	} else if(nBestHeight >= 498000 && nBestHeight < 504999){
      nSubsidy = 6 * COIN;	  
	} else if(nBestHeight >= 505000 && nBestHeight < 511999){
      nSubsidy = 5.75 * COIN;	  
	} else if(nBestHeight >= 512000 && nBestHeight < 518999){
      nSubsidy = 5.50 * COIN;	  
	} else if(nBestHeight >= 519000 && nBestHeight < 525999){
      nSubsidy = 5.25 * COIN;	  
	} else if(nBestHeight >= 526000 && nBestHeight < 532999){
      nSubsidy = 5 * COIN;	  
	} else if(nBestHeight >= 533000 && nBestHeight < 539999){
      nSubsidy = 4.50 * COIN;	  
	} else if(nBestHeight >= 540000 && nBestHeight < 600000){
      nSubsidy = 4.25* COIN;	  
    }
    }
...
#ifdef ENABLE_WALLET
// Cblcoin: attempt to generate suitable proof-of-stake
