...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeCblcoinAmount"))
        settings.setValue("nAnonymizeCblcoinAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeCblcoinAmount = settings.value("nAnonymizeCblcoinAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeCblcoinAmount"))
        SoftSetArg("-anonymizeCblcoinamount", settings.value("nAnonymizeCblcoinAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeCblcoinAmount:
            nAnonymizeCblcoinAmount = value.toInt();
            settings.setValue("nAnonymizeCblcoinAmount", nAnonymizeCblcoinAmount);
            emit anonymizeCblcoinAmountChanged(nAnonymizeCblcoinAmount);
            break;
        default:
            break;
        }
